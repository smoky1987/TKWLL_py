...
# # CODUL TĂU VINE MAI JOS:
def task_5(n):
    return ['par' if i%2==0 else 'impar' for i in range(1, n)]
print('task_5')
print(task_5(101))
# # CODUL TĂU VINE MAI SUS:
...
"""
Task: Creați o funcție cu numele "task_7" care utilizând list comprehension va returna
un set cu multiplii 
...
def task_7(n):
    myDict = {}
    return sorted({i*3 for i in range(1,n+1)})
print('task_7')
print(task_7(50))
# # CODUL TĂU VINE MAI SUS:
...
"""
Task: Creați o funcție cu numele "task_13" care acceptă două numere și 
returnează suma și produsul lor.
...
"""
Task: Creați o funcție cu numele "task_19" care acceptă un număr și returnează `True`
 dacă numărul este prim, altfel `False`.
